...
def prde_no_cancel_b_large(b, Q, n, DE) -> tuple[list[Any], PolyMatrix | Any]:
    """
...
def prde_no_cancel_b_small(b, Q, n, DE) -> tuple[list[Any], PolyMatrix | Any]:
    """
...
def param_poly_rischDE(a, b, q, n, DE) -> tuple[list[Any], PolyMatrix] | tuple[list[Any], PolyMatrix | list[Any] | Any] | tuple[list[Any], PolyMatrix | Any] | tuple[list[Any], Any] | tuple[list[list[Any] | Any | PolyMatrix], PolyMatrix]:
...
def is_log_deriv_k_t_radical(fa, fd, DE, Df=...) -> tuple[list[tuple[Any, Any]], Any | Order, Any, Any] | None:
    r"""
...
def is_log_deriv_k_t_radical_in_field(fa, fd, DE, case=..., z=...) -> tuple[Any, Any | Order] | tuple[Any, Any] | None:
    """
