...
class Mul(Expr, AssocOp):
    ...
    @cacheit
    def as_two_terms(self) -> tuple[Any, Self] | tTuple[Expr, Expr] | tuple[Expr, Any | Self]:
    ...
    @cacheit
    def as_coeff_mul(self, *deps, rational=..., **kwargs) -> tuple[Any | Self, tuple[Any, ...]] | tuple[Expr, tuple[Expr, ...]] | tuple[Any, tuple[Any | Mul, *tuple[Expr, ...]]] | tuple[Any, tTuple[Expr, ...]]:
        ...
    
    def as_coeff_Mul(self, rational=...) -> tuple[Expr, Expr] | tuple[Expr, Any | Self] | tuple[Any, Any | Self] | tuple[Any, Self]:
        """
