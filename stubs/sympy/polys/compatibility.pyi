...
class IPolys:
    ...
    def dup_LC(self, f) -> list[Any]:
        ...
    
    def dmp_LC(self, f):
        ...
    
    def dup_TC(self, f) -> list[Any]:
        ...
    ...
    def dmp_resultant(self, f, g) -> tuple[Any, list[Any]] | tuple[list[list[Any]], list[Any]] | tuple[list[list[Any]] | Any | list[Any], list[Any]]:
        ...
    ...
    def dup_zz_factor(self, f) -> tuple[Any, list[tuple[None, Any | Literal[1]]]]:
        ...
    
    def dmp_zz_factor(self, f) -> tuple[Any, list[tuple[None, Any | Literal[1]]]]:
        ...
    ...
    def dup_ext_factor(self, f) -> tuple[Any, list[tuple[None, float | int]]]:
        ...
    
    def dmp_ext_factor(self, f) -> tuple[Any, list[tuple[None, float | int]]]:
        ...
    ...
    def dup_isolate_all_roots_sqf(self, f, eps=..., inf=..., sup=..., fast=..., blackbox=...) -> tuple[list[Any] | list[tuple[Any, Any] | tuple[Any | list[Any], tuple[Any, Any, Any, Any]]] | list[RealInterval], Any]:
        ...
