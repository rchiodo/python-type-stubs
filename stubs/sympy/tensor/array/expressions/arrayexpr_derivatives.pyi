...
from sympy.tensor.array.expressions.array_expressions import ArrayAdd, ArrayContraction, ArrayDiagonal, ArrayElementwiseApplyFunc, ArraySymbol, ArrayTensorProduct, PermuteDims, Reshape, _ArrayExpr
...
def _(expr: ArrayContraction, x: Expr) -> Basic | ZeroArray | ArrayTensorProduct | ArrayContraction:
    ...
